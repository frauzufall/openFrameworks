...
class ofxTextInputField {
  public:
	...
	bool keyPressed(ofKeyEventArgs &a);
	bool keyReleased(ofKeyEventArgs &a);
	bool mouseMoved(ofMouseEventArgs& args){return false;}
	bool mouseScrolled(ofMouseEventArgs& args){return false;}
	bool mouseEntered(ofMouseEventArgs& args){return false;}
	bool mouseExited(ofMouseEventArgs& args){return false;}
  ...
  protected:
	...
	string getCroppedText(std::string text, float offset_beginning, float width);
